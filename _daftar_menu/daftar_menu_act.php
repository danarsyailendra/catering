...
for ($i = 0; $i < $makanan[rowsnum]; $i++) {
    ...
    <ul class="dropdown-menu" role="menu">';
        ...
        //if ($makanan[$i][6] == 0) {
            $button .= '<li><a href="_daftar_menu/daftar_update_menu.php?id=' . $makanan[$i][0] . '" data-toggle="modal" data-target="#modal_update_daftar_menu">Display / Update Menu</a></li>';
            $button .= '<li><a href="_daftar_menu/daftar_delete_menu.php?id=' . $makanan[$i][0] . '" data-toggle="modal" data-target="#modal_delete_daftar_menu">Hapus Menu</a></li>';
        //} else {
            //$button .= '<a href="#"></a>';
        //}
